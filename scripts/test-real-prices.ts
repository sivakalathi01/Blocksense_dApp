...
async function main() {
  console.log('🧪 Testing Real Price Consumer...');
  
  // Contract address for the real price consumer
  ...
  for (const pair of pairs) {
    try {
      ...
      // Format price with the returned decimals
      ...
      if (numericPrice > 100000) {
        console.log('📝 Note: This appears to be test data');
      } else {
